const Hero = () => {
  return (
    <div
      className="w-full min-h-screen bg-[#f4f4f0] overflow-hidden relative flex flex-col justify-between"
      style={{
        backgroundImage:
    ...
    >
      ...
      <section
        id="home"
        className="w-full max-w-5xl mx-auto flex-1 pt-24 pb-10 px-4 sm:px-8 flex flex-col items-center justify-center text-center relative z-10"
      >
        ...
        <p className="text-sm sm:text-xl md:text-2xl font-bold text-zinc-700 max-w-sm sm:max-w-2xl font-sans leading-relaxed mt-8 px-2 sm:px-4">
          Mahasiswa Sistem Informasi yang suka ngulik kode, dan menciptakan
          solusi digital yang solutif.
        </p>

        {/* Diubah px-20 menjadi px-4 di mobile agar tombol tidak kepotong/terlalu tinggi */}
        <div className="mt-6 flex flex-col sm:flex-row gap-3 w-full px-4 sm:px-0 sm:w-auto">
          <a
            href="#projects"
      ...
      {/* Marquee sebagai footer dari Hero (Menjadi pembatas rapat ke section berikutnya) */}
      <div className="w-full bg-pink-600 border-t-4 border-b-4 border-black py-2 sm:py-4 overflow-hidden select-none z-20">
